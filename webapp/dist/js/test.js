...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testModule = __webpack_require__(298);

	var testModel = _interopRequireWildcard(_testModule);

	var _testModule2 = __webpack_require__(367);

	var _testModule3 = _interopRequireDefault(_testModule2);

	var _vue = __webpack_require__(368);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _regenerator = __webpack_require__(299);
	...
	var timeoutFn = exports.timeoutFn = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toInteger = __webpack_require__(307)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY        = __webpack_require__(310)
	  ...
	  , redefine       = __webpack_require__(326)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(316)(IteratorPrototype, __webpack_require__(346)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anObject    = __webpack_require__(318)
	  ...
	  , enumBugKeys = __webpack_require__(343)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(312)
	  , hide          = __webpack_require__(316)
	  , Iterators     = __webpack_require__(328)
	  , TO_STRING_TAG = __webpack_require__(346)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var LIBRARY            = __webpack_require__(310)
	  , global             = __webpack_require__(312)
	  , ctx                = __webpack_require__(314)
	  , classof            = __webpack_require__(354)
	  , $export            = __webpack_require__(311)
	  , isObject           = __webpack_require__(319)
	  , aFunction          = __webpack_require__(315)
	  , anInstance         = __webpack_require__(355)
	  , forOf              = __webpack_require__(356)
	  , speciesConstructor = __webpack_require__(360)
	  , task               = __webpack_require__(361).set
	  , microtask          = __webpack_require__(363)()
	  , PROMISE            = 'Promise'
	  , TypeError          = global.TypeError
	  , process            = global.process
	  , $Promise           = global[PROMISE]
	...
	var USE_NATIVE = !!function(){
	  try {
	    // correct subclassing with @@species support
	    var promise     = $Promise.resolve(1)
	      , FakePromise = (promise.constructor = {})[__webpack_require__(346)('species')] = function(exec){ exec(empty, empty); };
	    // unhandled rejections tracking support, NodeJS Promise without it fails @@species test
	    return (isNode || typeof PromiseRejectionEvent == 'function') && promise.then(empty) instanceof FakePromise;
	  } catch(e){ /* empty */ }
	}();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anObject  = __webpack_require__(318)
	  , aFunction = __webpack_require__(315)
	  , SPECIES   = __webpack_require__(346)('species');
	module.exports = function(O, D){
	  var C = anObject(O).constructor, S;
	  return C === undefined || (S = anObject(C)[SPECIES]) == undefined ? D : aFunction(S);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!setTask || !clearTask){
	  ...
	  // Node.js 0.8-
	  if(__webpack_require__(336)(process) == 'process'){
	    defer = function(id){
	      process.nextTick(ctx(run, id, 1));
	    };
	  // Browsers with MessageChannel, includes WebWorkers
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(312)
	  ...
	  , process   = global.process
	  , Promise   = global.Promise
	  , isNode    = __webpack_require__(336)(process) == 'process';
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] webapp\\src\\components\\App.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\r\nhtml {\r\n  height: 100%;\r\n}\r\n\r\nbody {\r\n  display: -webkit-box;\r\n  display: -ms-flexbox;\r\n  display: flex;\r\n  -webkit-box-align: center;\r\n      -ms-flex-align: center;\r\n          align-items: center;\r\n  -webkit-box-pack: center;\r\n      -ms-flex-pack: center;\r\n          justify-content: center;\r\n  height: 100%;\r\n}\r\n\r\n#app {\r\n  color: #2c3e50;\r\n  margin-top: -100px;\r\n  max-width: 600px;\r\n  font-family: Source Sans Pro, Helvetica, sans-serif;\r\n  text-align: center;\r\n}\r\n\r\n#app a {\r\n  color: #42b983;\r\n  text-decoration: none;\r\n}\r\n\r\n.logo {\r\n  width: 100px;\r\n  height: 100px\r\n}\r\n", "", {"version":3,"sources":["/./src/components/App.vue?0745d300"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAkCA;EACA,aAAA;CACA;;AAEA;EACA,qBAAA;EAAA,qBAAA;EAAA,cAAA;EACA,0BAAA;MAAA,uBAAA;UAAA,oBAAA;EACA,yBAAA;MAAA,sBAAA;UAAA,wBAAA;EACA,aAAA;CACA;;AAEA;EACA,eAAA;EACA,mBAAA;EACA,iBAAA;EACA,oDAAA;EACA,mBAAA;CACA;;AAEA;EACA,eAAA;EACA,sBAAA;CACA;;AAEA;EACA,aAAA;EACA,aAAA;CACA","file":"App.vue","sourcesContent":["<template>\r\n  <div id=\"app\">\r\n    <hello></hello>\r\n    <p>\r\n      Welcome to your Vue.js app!\r\n    </p>\r\n    <p>\r\n      To get a better understanding of how this boilerplate works, check out\r\n      <a href=\"http://vuejs-templates.github.io/webpack\" target=\"_blank\">its documentation</a>.\r\n      It is also recommended to go through the docs for\r\n      <a href=\"http://webpack.github.io/\" target=\"_blank\">Webpack</a> and\r\n      <a href=\"http://vuejs.github.io/vue-loader/\" target=\"_blank\">vue-loader</a>.\r\n      If you have any issues with the setup, please file an issue at this boilerplate's\r\n      <a href=\"https://github.com/vuejs-templates/webpack\" target=\"_blank\">repository</a>.\r\n    </p>\r\n    <p>\r\n      You may also want to checkout\r\n      <a href=\"https://github.com/vuejs/vue-router/\" target=\"_blank\">vue-router</a> for routing and\r\n      <a href=\"https://github.com/vuejs/vuex/\" target=\"_blank\">vuex</a> for state management.\r\n    </p>\r\n  </div>\r\n</template>\r\n\r\n<script>\r\nimport Hello from 'components/Hello'\r\n\r\nexport default {\r\n  components: {\r\n    Hello\r\n  }\r\n}\r\n</script>\r\n\r\n<style>\r\nhtml {\r\n  height: 100%;\r\n}\r\n\r\nbody {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  height: 100%;\r\n}\r\n\r\n#app {\r\n  color: #2c3e50;\r\n  margin-top: -100px;\r\n  max-width: 600px;\r\n  font-family: Source Sans Pro, Helvetica, sans-serif;\r\n  text-align: center;\r\n}\r\n\r\n#app a {\r\n  color: #42b983;\r\n  text-decoration: none;\r\n}\r\n\r\n.logo {\r\n  width: 100px;\r\n  height: 100px\r\n}\r\n</style>\r\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Hello = __webpack_require__(375);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] webapp\\src\\components\\Hello.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-514cc72a&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Hello.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-514cc72a&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Hello.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nh1[_v-514cc72a] {\n  color: #42b983;\n}\n", "", {"version":3,"sources":["/./src/components/Hello.vue?3fd8edb5"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;AAsBA;EACA,eAAA;CACA","file":"Hello.vue","sourcesContent":["<template>\n  <div class=\"hello\">\n    <h1>{{ msg }}</h1>\n  </div>\n</template>\n\n<script>\nexport default {\n  data () {\n    return {\n      // note: changing this line won't causes changes\n      // with hot-reload because the reloaded component\n      // preserves its current state and we are modifying\n      // its initial state.\n      msg: 'Hello World!'\n    }\n  }\n}\n</script>\n\n<!-- Add \"scoped\" attribute to limit CSS to this component only -->\n<style scoped>\nh1 {\n  color: #42b983;\n}\n</style>\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"hello\" _v-514cc72a=\"\">\n  <h1 _v-514cc72a=\"\">{{ msg }}</h1>\n</div>\n";
